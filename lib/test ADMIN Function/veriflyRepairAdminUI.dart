...
class VeriflyRepairAdminUI extends StatefulWidget {
  final String borrow_id;
  const VeriflyRepairAdminUI({Key? key, required this.borrow_id})
      : super(key: key);

  @override
  State<VeriflyRepairAdminUI> createState() => _VeriflyRepairAdminUIState();
}

class _VeriflyRepairAdminUIState extends State<VeriflyRepairAdminUI> {
  bool isCheckedNormal = false;
  bool isCheckedProblem = false;
  final TextEditingController _noteController = TextEditingController();

  late Future<List<VeriflyDetails>> _get_assetVeriflyRepair;

  final TextInputType keyboardTypeText = TextInputType.text;

  get_assetVeriflyRepair() async {
    setState(() {
      _get_assetVeriflyRepair = API.getAssetVeriflyRepair(widget.borrow_id);
    });
  }
          ...
          child: Column(
            children: [
              Container(
                height: 320,
                child: FutureBuilder(
                  future: _get_assetVeriflyRepair,
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          Constants.whiteColor.withOpacity(.5),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Checkbox(
                              ...
                              onChanged: (bool? value) {
                                setState(() {
                                  // ส่งค่าไปให้ API ว่า ปกติ หรือ มีปัญหา
